...
export default async function NewBusinessRequestPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <PageHeader title="Nouvelle demande" description="Decrivez votre besoin d'hébergement professionnel." />
      <div className="rounded-3xl border border-border bg-surface p-6 shadow-soft">
        <LeadForm
          action={createMyBusinessRequest as never}
          submitLabel="Envoyer la demande"
          fields={[
            { name: "needType", label: "Type de besoin", required: true, full: true, placeholder: "Hébergement équipe en mission" },
            ...
            { name: "notes", label: "Détails", type: "textarea", placeholder: "Dates, exigences (WiFi, calme...), facturation..." },
          ]}
        />
      </div>
    </div>
